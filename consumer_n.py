...
def process_message(message):
    ...
    if order_purchase_timestamp_str is not None:
        ...
        order_purchase_timestamp=datetime.strptime("2017-10-02 11:07:15", '%Y-%m-%d %H:%M:%S')
    ...
    if order_approved_at_str is not None:
        ...
        order_approved_at=datetime.strptime("2017-10-02 11:07:15", '%Y-%m-%d %H:%M:%S')
    ...
    if order_delivered_carrier_date_str is not None:
        ...
        order_delivered_carrier_data=datetime.strptime("2017-10-02 11:07:15", '%Y-%m-%d %H:%M:%S')
    ...
    if order_delivered_customer_date_str is not None:
        ...
        order_delivered_customer_date=datetime.strptime("2017-10-02 11:07:15", '%Y-%m-%d %H:%M:%S')
    ...
    if order_estimated_delivery_date_str is not None:
        ...
        order_estimated_delivery_date=datetime.strptime("2017-10-02 11:07:15", '%Y-%m-%d %H:%M:%S')
